...
//	auto functionCallKind = *_spawnCall.annotation().kind;
	...
	CompilerContext::LocationSetter locationSetter(m_context, _spawnCall);
//	solAssert(functionCallKind == FunctionCallKind::SpawnCall, "");
    ...
    switch (function.kind())
    {
		case FunctionType::Kind::Internal:
		{
...

            {
                ...
                if (auto identifier = dynamic_cast<Identifier const*>(&_spawnCall.expression()))
                {
                ...
                if (!shortcutTaken)
                    _spawnCall.expression().accept(*this);
            }
