...
bool PostTypeChecker::visit(SpawnStatement const& _spawn)
{
	return callVisit(_spawn);
}

void PostTypeChecker::endVisit(SpawnStatement const& _spawn)
{
	callEndVisit(_spawn);
}
...
bool PostTypeChecker::visit(XSpawnCallStatement const& _xspawn)
{
    return callVisit(_xspawn);
}

void PostTypeChecker::endVisit(XSpawnCallStatement const& _xspawn)
{
    callEndVisit(_xspawn);
}
...
struct EventOutsideEmitErrorOutsideRevertChecker: public PostTypeChecker::Checker
{
	...
	{
		m_currentStatement = &_spawnStatement;
		return true;
	}

	void endVisit(SpawnStatement const&) override
	{
		m_currentStatement = nullptr;
	}
    ...
    void endVisit(XSpawnCallStatement const&) override
    {
        m_currentStatement = nullptr;
    }
